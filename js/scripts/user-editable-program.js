...
`
const USER_DEFINED_3D_POTENTIAL_FRAG1 = 
`
uniform complex width;
uniform complex height;
...
const USER_DEFINED_3D_POTENTIAL_FRAG2 = 
`;
}
...
export class UserEditable3DPotentialProgramContainer
extends UserEditableProgramContainer {
    _constructUserShader(userUniformString, userExpressionString) {
        return (COMPLEX_FUNCS_SHADER
            + userUniformString
            + USER_DEFINED_3D_POTENTIAL_FRAG1
            + userExpressionString
            + USER_DEFINED_3D_POTENTIAL_FRAG2
            + MAIN_FUNC_SHADER);
    }
    _removeReservedVariables(variables) {
